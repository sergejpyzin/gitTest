...
1. Основные команды:
    ...
    > [**git commit**](https://www.atlassian.com/ru/git/tutorials/saving-changes/git-commit#:~:text=Search-,Git%20commit,-git%20add%20git) - создание коммита с вызовом текстового редактора
        >> *git commit* флаги:
        >> - **-m** - набор текста в терминальной строке;
        >> - **-am** - позволяет объеденить команды **git add** и **git commit**
